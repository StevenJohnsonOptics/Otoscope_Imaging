...
"""building code for the combining of the images and the object for the phase
 ...
 x = [] for i in range(800): x.append(i+1) repetitions = 600 x1 = np.tile(x,(repetitions,1)) print(x1) #the object Height = 1
...
#then the equations started but need some clarifying Ixy = IIxy = o1 = (wx)+obj o2 = (wx)+obj+((2np.pi)/3) o3 = (wx)+obj+((4np.pi)/3) I1 = Ixy +(IIxy(cos(o1))) I2 = Ixy +(IIxy*(cos(o2))) I3 = Ixy +(IIxy*(cos(o3))) oxy = atan(sqrt(3)(I1-I3)/((2*I2)-I1-I3))